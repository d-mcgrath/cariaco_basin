...
All MAGs and biosynthetic gene clusters recovered using antiSMASH 6.0 are available in the repository: https://osf.io/usm8r/. All data used to create the figures and supplementary figures in this study is available in the [source_data](https://github.com/d-mcgrath/cariaco_basin/tree/main/source_data) folder.

...
title: Particles are hotspots of microbial secondary metabolite biosynthetic gene
  clusters through the permanently anoxic Cariaco Basin
...
# metadata file of gene names
# load('../minimap2_metaT_mapping_final_results_used/rdata/deseq2_full_analysis_with_minimap2_metaT_alignments.rdata')
#
# empty_gene_counts_filler = mapped_read_counts |>
#   select(gene_name) |>
#   mutate(n_reads_mapped = 0L)
#
# saveRDS(empty_gene_counts_filler, file = 'rdata/metaG_empty_gene_counts_filler.rds')
#rm(list = ls())
...
<br>
Format gene/protein domain annotation and expression data, save the data as a supplementary table, plot the genomic potential/transcript expression

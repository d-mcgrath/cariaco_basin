...
mag_data = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/mags_75compl_5cont.tsv.gz',
...
bgc_count_data_summary = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/bgc_count_data_summary.tsv.gz')
...
```{r}
mm2_final = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/logTransformed_tpm_for_bgc_genes_minimap2_res.tsv.gz')
...
rnaseq_mapping_counts = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/rnaseq_read_mapping_minimap2_on_cariaco_genes.tsv.gz')

bgc_genes_10kb = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/bgc_genes_10kb.tsv.gz')

mm2_final = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/logTransformed_tpm_for_bgc_genes_minimap2_res.tsv.gz')

col_metadata = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/col_metadata.tsv.gz')
...
dnaseq_umap_tbl = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/metaG_processed_mapping_tbl.tsv.gz')
...
final_domain_summary = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile//final_domain_summary.tsv.gz')
final_de_and_clust_data = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/final_de_and_clust_data.tsv.gz')
...
sm_key = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/sm_key.tsv.gz')
mag_table = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/mag_table.tsv.gz')
...
final_genome_rel_abun_tbl = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/rel_abun_tibble_48_samples.tsv.gz')
...
```{r eval=FALSE, include=TRUE}
mag_table = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/mags_75compl_5cont.tsv.gz', show_col_types = FALSE)
...
write_tsv(allDaResults, file = '~/Documents/cariaco-tidy-analysis/rds_to_flatfile/deseq2_results_by_water_layer.tsv.gz')
```
...
allDaResults = read_tsv(file = '~/Documents/cariaco-tidy-analysis/rds_to_flatfile/deseq2_results_by_water_layer.tsv.gz')
...
```{r}
bgc_summary = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/bgc_summary.tsv.gz')
...
gl = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/gene_lengths_tibble.tsv.gz')
...
empty_gene_counts_filler = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/metaG_empty_gene_counts_filler.tsv.gz')
...
mapped_read_counts %>% write_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/list_of_mapped_metaT_reads_from_each_sample.tsv.gz')
...
test_final_de = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/final_de_and_uniq_expr_clust_data.tsv.gz')
...
```{r}
clust_gene_summary = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/clust_gene_summary.tsv.gz')
...
#####
logTransformed_tpm_for_bgc_genes_minimap2_res = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/logTransformed_tpm_for_bgc_genes_minimap2_res.tsv.gz')
...
```{r}
logTransformed_tpm_for_bgc_genes_minimap2_res = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/logTransformed_tpm_for_bgc_genes_minimap2_res.tsv.gz')
ladderane_colAnno = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile//ladderane_colAnno.tsv.gz')

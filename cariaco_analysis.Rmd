...
# save the list of processed files
write_tsv(processed_mapping_counts, file = '~/Documents/cariaco-tidy-analysis/rds_to_flatfile/flatfiles/tbl_of_mapped_metaG_reads_from_each_sample.tsv.gz')


# to view the output:
processed_mapping_counts = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/flatfiles/tbl_of_mapped_metaG_reads_from_each_sample.tsv.gz')
...
mapped_read_counts = read_tsv('~/Documents/cariaco-tidy-analysis/rds_to_flatfile/flatfiles/list_of_mapped_metaT_reads_from_each_sample.tsv.gz')
